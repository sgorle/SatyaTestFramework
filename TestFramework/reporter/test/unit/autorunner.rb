#require File.expand_path(File.dirname(__FILE__) + '/test/unit')
require File.expand_path(File.dirname(__FILE__) + '/ui/testrunnerutilities')
require 'optparse'
...
module Test
  module Unit
    class AutoRunner
      ...
      RUNNERS = {
        :console => proc do |r|
          require File.expand_path(File.dirname(__FILE__) + '/ui/console/testrunner')
          Test::Unit::UI::Console::TestRunner
        end,
        :gtk => proc do |r|
          require File.expand_path(File.dirname(__FILE__) + '/ui/gtk/testrunner')
      ...
      COLLECTORS = {
        :objectspace => proc do |r|
          require File.expand_path(File.dirname(__FILE__) + '/collector/objectspace')
